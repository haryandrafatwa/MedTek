...
import com.example.medtek.Pasien.Home.Appointment.CheckoutAppointmentFragment;
...
public class EditProfileFragment extends Fragment {
    ...
    private String photoFileName = "avatar.png";
    ...
    public void onStart() {
        ...
        male.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!updateJK.equalsIgnoreCase(jenis_kelamin)){
                    btn_simpan.setEnabled(true);
                }else{
                    btn_simpan.setEnabled(false);
                }
