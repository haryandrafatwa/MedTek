...
import com.example.medtek.model.pasien.SearchModel;
...
public class SearchFragment extends Fragment {
    ...
    private final List<SearchModel> listDokter = new ArrayList<>();
    private final List<SearchModel> mListDokter = new ArrayList<>();
    private List<SearchModel> mListRs;
    private final List<SearchModel> listRs = new ArrayList<>();
