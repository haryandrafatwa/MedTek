...
public class DokterAdapterMore extends RecyclerView.Adapter<DokterAdapterMore.ViewHolder> implements Filterable {
    private final List<DokterModel> mList;
    private final List<DokterModel> mListFull;
    ...
    private final Filter doctorsFilter = new Filter() {
        @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private final TextView tv_lamakerja;
