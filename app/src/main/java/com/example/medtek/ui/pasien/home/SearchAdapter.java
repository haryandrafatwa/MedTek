...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> implements Filterable {
    private final List<SearchModel> mList;
    private final List<SearchModel> mListFull;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (model.getImage_url().equalsIgnoreCase(BASE_URL+"/storage/Dokter.png")){
    ...
    private final Filter searchFilters = new Filter() {
        @Override
