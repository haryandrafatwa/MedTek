...
public class DokterFragment extends Fragment {
    ...
    private final List<DokterModel> mList = new ArrayList<>();
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        Log.d("MedTekMedTek", valueOf(id));
                        Log.d("MedTekMedTek", name);
                        Log.d("MedTekMedTek", spec);
                        Log.d("MedTekMedTek", rs_name);
                        Log.d("MedTekMedTek", rs_loc);
                        Log.d("MedTekMedTek", path);
                        Log.d("MedTekMedTek", valueOf(harga));
                        Log.d("MedTekMedTek", valueOf(isVerified));
                        Log.d("MedTekMedTek", valueOf(lamakerja));
